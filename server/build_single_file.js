...
<body>
  ...
  <header class="header-bar">
      ...
      <div class="logo-box">
        ...
        <div>
          <div style="display: flex; align-items: center; gap: 0.5rem;">
            <h1 style="font-size: 1.05rem; font-weight: 800; font-family: var(--font-mono); letter-spacing: -0.02em;">SENSOR ML BENCHMARK</h1>
            <span style="font-size: 0.65rem; font-family: var(--font-mono); background: rgba(6, 182, 212, 0.15); color: #67e8f9; border: 1px solid rgba(6, 182, 212, 0.35); padding: 0.15rem 0.4rem; border-radius: 0.35rem; font-weight: 700;">ISO/SIL-2 READY</span>
          </div>
          <p style="font-size: 0.72rem; color: var(--text-muted); font-family: var(--font-mono);">Automated Multi-Sensor Anomaly Audit & 3D Digital Twin (Standalone)</p>
        </div>
      </div>

      <!-- Action Toolbar -->
      <div class="action-group">
        <div style="display: flex; align-items: center; gap: 0.4rem; font-family: var(--font-mono); font-size: 0.7rem; background: rgba(15, 23, 42, 0.8); border: 1px solid var(--border-color); padding: 0.35rem 0.7rem; border-radius: 0.5rem;">
          <span style="width: 8px; height: 8px; border-radius: 50%; background: #10b981; display: inline-block; box-shadow: 0 0 8px #10b981;"></span>
          <span>STANDALONE BUNDLE (260 RECS)</span>
        </div>

        <button class="btn-action" style="background: rgba(6, 182, 212, 0.15); border-color: rgba(6, 182, 212, 0.4); color: #38bdf8;" onclick="openModal('audio-modal')">
        ...
        <button class="btn-action btn-dossier" onclick="openModal('dossier-modal')">
    ...
    <nav class="main-nav">
      ...
      <button class="nav-btn" onclick="switchTab('diagnostics')">🚨 Top 3 Diagnostician (5 Anomalies)</button>
  ...
  <div id="export-modal" class="modal-overlay">
    <div class="modal-box">
      ...
      <div class="modal-body font-mono">
        ...
        <div class="kpi-box" style="display: flex; justify-content: space-between; align-items: center;">
          <div>
